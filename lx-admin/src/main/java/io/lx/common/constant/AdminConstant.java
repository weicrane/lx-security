...
public interface AdminConstant {
    ...
    //  ==========  strat 线路相关 ==========
    // kml维护
    String NAME_MAIN_ROUTE_ALL = "主线总览";
    String NAME_OTHERS_ROUTE_ALL = "小众玩法总览";
